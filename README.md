...
Enter any prompt – the model will respond as if running on real hardware, with simulated latency and log output.
...
**This proves** – without any hardware – that the compiler produces correct, deterministic outputs. The FPGA version is identical, just 20× faster and 100× more energy‑efficient.
